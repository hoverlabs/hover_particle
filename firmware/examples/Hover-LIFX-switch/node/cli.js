...
var spark = require('sparknode');	//new
var lx = lifx.init();
var core = new spark.Core({accessToken: "e7bd2df80cd1dbd706d77131e2c9685db7c6df15", id: "53ff72065075535115541687"});
var lightColor = ["red", "purple", "white"];

core.on('connect', function(info) {	//new
	console.log(info);
	console.log(info.data);
	console.log("test");
});	

core.on('getEvent', function(info) {
	console.log(info);
	console.log(info.data);
	...
	switch (info.data) {
		...
		case '34': 
			lightColor.unshift(lightColor.pop());
			console.log(lightColor);
			
			if (lightColor[1]=="red"){
				lx.lightsColour(0x0000, 0xffff, 1000, 0, 0);
			} else if (lightColor[1]=="purple") {
		...
		case '36': 
			lightColor.push(lightColor.shift());
			console.log(lightColor);
